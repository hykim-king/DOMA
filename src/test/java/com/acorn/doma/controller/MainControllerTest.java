...
public class MainControllerTest implements PLog {
	...
	public void setUp() throws Exception {
		...
		accident01 = new Accident("1112", "A01", "12B01", "강남 한복판에서 현석이형이..", "2024-08-06", "11:30:00", "2024-08-06",
				"11:30:00", 11, 11);
...
//	@Ignore
	...
	public void accIdSelect() throws Exception {
		...
		assertEquals(1, flag);
		Accident accIdSelectVO = accInfoService.doSelectOne(accident01);

		
		MockHttpServletRequestBuilder requestBuilder =
		MockMvcRequestBuilders.get("/main/accIdSelect.do")
		.param("accId",accIdSelectVO.getAccId());
		...
		Accident acc = (Accident) modelMap.get("accIdSelect");
		log.debug(acc);
	...
	public void freezing() throws Exception {
		...
		log.debug("│ freezing()                │");
		log.debug("└───────────────────────────┘");
		MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/main/freezing.do");
