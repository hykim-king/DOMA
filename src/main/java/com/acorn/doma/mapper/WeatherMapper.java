...
public interface WeatherMapper {
    ...
    // 연도별 날씨 조건 발생 빈도
    List<Map<String, Object>> weatherFreqByYear(@Param("year") int year) throws SQLException;

    // 연도별 부상자 수 합산이 가장 많은 구 상위 5개
    List<Map<String, Object>> top5InjuryByRegion(@Param("year") int year) throws SQLException;
