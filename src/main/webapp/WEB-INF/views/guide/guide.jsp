        ...
        <section>
            ...
            <div>
                    ...
                    <ul>
                        ...
                        <li class="flex flex_center_2 flex_space">
                            ...
                            <div class="info_contents">
                                ...
                                <p class="info_content">집회/행사로 인한 혼잡한 지접을 표시합니다</p>
                            </div>
                        </li>
                        <li class="flex flex_center_2 flex_space">
                            <div class="info_icon">
                ...
                <div>
                    ...
                    <ul>
                        <li class="flex flex_space">
                            <p class="info_content">지도에는 돌발, 결빙, 사고다발 정보를 표시합니다.</p>
                        </li>
                    </ul>
                    <ul>
                        <li class="flex flex_center_2 flex_space">
                            <div class="info_contents">
                                ...
                                <p class="info_content">
                                    서울 시 내 돌발 정보를 실시간으로 제공합니다.<br>리스트의 상단 바를 클릭 시 해당 위치를 중심으로 지도가 반영됩니다.</p>
                            </div>
                        </li>
                        <li class="flex flex_center_2 flex_space">
                            <div class="info_contents">
                        ...
                        <li class="flex flex_center_2 flex_space">
                            <div class="info_contents">
                                ...
                                <p class="info_content">
                                    ...
                                    년도를 선택 후, 지역을 선택하고 조회를 할 시 위험도에 따른 마커를 표시합니다.<br>
                                    위험도는 1~5로 해당 년도의 사고 발생 건수의 백분위를 5구간으로 나눈 정보입니다.                                    
                                </p>
                            </div>
                      </li>
                </ul>
                ...
                <div>
                    ...
                    <ul>
                        <li class="flex flex_center_2 flex_space">
                            <div class="info_contents">
                                <h4 class="info_title bold_font">싱황별 안전 정보</h4>
                                <p class="info_content">
                                    다양한 상황에서 안전을 지키기 위한 정보를 제공합니다.</p>
                            </div>
                        </li>
                        <li class="flex flex_center_2 flex_space">
                            <div class="info_contents">
                                ...
                                <p class="info_content">
                                    긴급한 상황에서 효과적으로 대처하는 방법을 안내합니다.</p>
                            </div>
                        </li>
                   </ul>
                </div>
                    ...
                    <ul>
                        <li class="flex flex_center_2 flex_space">
                            <div class="info_contents">
                                ...
                                <p class="info_content">
                                    이용자가 현재 돌발 정보를 게시합니다.<br>지역별로 현재 상황을 공유하고 소통하며 위험에 대비합니다.</p>
                            </div>
                        </li>
                        <li class="flex flex_center_2 flex_space">
                            <div class="info_contents">
